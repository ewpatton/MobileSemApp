...
<html>
  ...
  <body class="logged_out page-blob  env-production">
    ...
    <ul class="actions">
        ...
        <li>
          <a href="/douglascrockford/JSON-js/toggle_watch" class="minibutton btn-watch " id="watch_button" onclick="var f = document.createElement('form'); f.style.display = 'none'; this.parentNode.appendChild(f); f.method = 'POST'; f.action = this.href;var s = document.createElement('input'); s.setAttribute('type', 'hidden'); s.setAttribute('name', 'authenticity_token'); s.setAttribute('value', '6a1462d6d4f2965ad414e02e7157697c6f69b941'); f.appendChild(s);f.submit();return false;" style="display:none"><span><span class="icon"></span>Watch</span></a>
          <a href="/douglascrockford/JSON-js/toggle_watch" class="minibutton btn-watch " id="unwatch_button" onclick="var f = document.createElement('form'); f.style.display = 'none'; this.parentNode.appendChild(f); f.method = 'POST'; f.action = this.href;var s = document.createElement('input'); s.setAttribute('type', 'hidden'); s.setAttribute('name', 'authenticity_token'); s.setAttribute('value', '6a1462d6d4f2965ad414e02e7157697c6f69b941'); f.appendChild(s);f.submit();return false;" style="display:none"><span><span class="icon"></span>Unwatch</span></a>
            ...
            <li class="for-notforked" style="display:none"><a href="/douglascrockford/JSON-js/fork" class="minibutton btn-fork " id="fork_button" onclick="var f = document.createElement('form'); f.style.display = 'none'; this.parentNode.appendChild(f); f.method = 'POST'; f.action = this.href;var s = document.createElement('input'); s.setAttribute('type', 'hidden'); s.setAttribute('name', 'authenticity_token'); s.setAttribute('value', '6a1462d6d4f2965ad414e02e7157697c6f69b941'); f.appendChild(s);f.submit();return false;"><span><span class="icon"></span>Fork</span></a></li>
      ...
      <li class="repostats">
        <ul class="repo-stats">
          <li class="watchers"><a href="/douglascrockford/JSON-js/watchers" title="Watchers" class="tooltipped downwards">556</a></li>
  ...
  <ul>
    ...
    <div id="repo_details" class="metabox clearfix">
      ...
      <div id="repository_description_edit" style="display:none;" class="inline-edit">
        <form action="/douglascrockford/JSON-js/admin/update" method="post"><div style="margin:0;padding:0"><input name="authenticity_token" type="hidden" value="6a1462d6d4f2965ad414e02e7157697c6f69b941" /></div>
  ...
  <img src="https://d3nwyuy0nl342s.cloudfront.net/images/modules/ajax/big_spinner_336699.gif" height="32" width="32">
    ...
    <div id="footer" class="clearfix">
      <div class="site">
        ...
        <ul class="sosueme">
          <li class="main">&copy; 2011 <span id="_rrt" title="0.04757s from fe1.rs.github.com">GitHub</span> Inc. All rights reserved.</li>
    ...
    <script>window._auth_token = "6a1462d6d4f2965ad414e02e7157697c6f69b941"</script>
...
`&lt;addr&gt;` element here instead.</pre>
    ...
    <script>(function(){var d=document;var e=d.createElement("script");e.async=true;e.src="https://d1ros97qkrwjf5.cloudfront.net/10/eum/rum.js	";var s=d.getElementsByTagName("script")[0];s.parentNode.insertBefore(e,s);})();NREUMQ.push(["nrf2","beacon-3.newrelic.com","2f94e4d8c2",64799,"dw1bEBZcX1RWRhoFCVkPXBAXHEBQXEM=",0,330,new Date().getTime()])</script>
  </body>
</html>
